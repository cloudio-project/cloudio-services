...
enum class EndpointModelElementPermission(private val value: Int) {
     ...
     */
    fun higher(permission: EndpointModelElementPermission) = arrayOf(this, permission).maxByOrNull { it.value } ?: DEFAULT
     ...
     */
    fun lower(permission: EndpointModelElementPermission) = arrayOf(this, permission).minByOrNull { it.value } ?: DEFAULT
