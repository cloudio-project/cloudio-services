...
@Entity
@Table(name = "cloudio_user_endpoint_group_permission", uniqueConstraints = [
    UniqueConstraint(columnNames = ["user_id", "endpoint_group_id"])
])
data class UserEndpointGroupPermission(
        @Column(name = "user_id")
        val userID: Long = 0,
        ...
        @JoinTable(name = "cloudio_user_endpoint_group_model_element_permission")
